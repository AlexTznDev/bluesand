...
(function () {
  ...
  function buildPacingTimeline(scene) {
    ...
    const headBits = qsa(card, '.pacing-title, .pacing-stat, .pacing-legend__item, .pacing-y, .pacing-x span');
    ...
    tl.to(card, {
      ...
      .to(grids, {
        scaleX: 1, duration: 0.8, ease: 'power2.out', stagger: 0.05
      }, 0.35);
    ...
    tl.to(lineExp, {
      ...
      .to(areaExp, {
        opacity: 0.28, duration: 0.8, ease: 'power1.out'
      }, 1.4)
      .to(areaAct, {
        opacity: 0.9, duration: 0.8, ease: 'power1.out'
      }, 1.55)
      .to(today, {
      ...
      .to(dots, {
        ...
        stagger: 0.08, ease: 'back.out(2.5)'
      }, 1.95);
  ...
  function buildChatTimeline(scene) {
    ...
    tl.to(card, {
      ...
      .to(msgs, {
        opacity: 1, y: 0, duration: 0.55, stagger: 0.22, ease: 'power2.out'
      }, 0.5);
